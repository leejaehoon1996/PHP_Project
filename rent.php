...
if (!session_id()) {
  ...
  $select_query = "select * FROM car where idx = '$idx'";        
...
<body>
   ...
   <div class="contact_section layout_padding">
      <div class="container">
         <h1 class="contact_taital">1일 차량대여</h1>

         <form action="rent_ok.php?carname=<?= $name?>&price=<?= $price?>" method="POST">

         <div class="email_text">
            <div class="form-group">
            <img src="./upload/<?= $filename?>" class="services_img1">
            <label for="nickname" style="font-size:20px">차종 : </label>
            <label for="nickname" style="font-size:20px" name="carname"><?= $name?></label><br>
            </div>
            <div class="form-group">
            <label for="nickname" style="font-size:20px">가격 : </label>
            <label for="nickname" style="font-size:20px" name="price"><?= $price?>원</label><br>
            </div>
            <div class="form-group">
            ...
            <input type="submit" class="send_btn1" value="대여하기">
            </div>
         </div>
            </form>
      </div>
