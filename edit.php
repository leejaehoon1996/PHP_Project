      ...
      <div class="container">
         ...
         <div class="email_text">
            <div class="form-group">
               ...
               <input type="password" class="email-bt" placeholder="변경할 비밀번호" name="pw" >
            </div>
            <div class="form-group">
               <label>변경할 E-mail</label>
               <input type="text" class="email-bt" placeholder="mail@naver.com" name="email" value="<?php echo $row['mail']?>">
            </div>
            <div class="form-group">
               <label>변경할 연락처</label>
               <input type="text" class="email-bt" placeholder="000-0000-0000" name="hp" value="<?php echo $row['ph']?>">
            </div>
            <div class="form-group">
               <label>변경할 주소</label>
               <input type="text" class="email-bt" placeholder="" name="addr" value="<?php echo $row['address']?>">
            </div>
            <input type="hidden" id="id" name="id" value="<?php echo $row['id']?>">
            <input type="submit" class="send_btn" value="수정하기">
            <input type="button" class="send_btn" value="회원탈퇴" onclick="location.href='del.php'">
         </div>
