<?php
    ...
    //쿼리문 실행
    $query = "select * from guest where id='$id' and pw='$pw'";
    ...
    if($id==$row['id'] && $pw==$row['pw']){ // id와 pw가 맞다면 login
        ...
        echo "<script>location.href='show_login.php';</script>";
     }
     
     else if($id=='admin' && $pw=='1234'){
        echo "<script>alert('관리자로그인')</script>";
        ...
        echo "<script>location.href='loginrent.php';</script>";
